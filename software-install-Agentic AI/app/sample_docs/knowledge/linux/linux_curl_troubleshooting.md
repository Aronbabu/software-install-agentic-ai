# Knowledge: curl Troubleshooting on Linux

## Purpose
Provide troubleshooting guidance when `curl` installation or verification fails on Linux targets.
...
### 3. `curl` command not found after install
Possible causes:
